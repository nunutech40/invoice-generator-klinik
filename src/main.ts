...
// ── WhatsApp CS floating button (global, all pages) ────────────────────
function mountWaButton() {
    if (document.getElementById('wa-float-btn')) return;
    const wa = document.createElement('a');
    wa.href = 'https://wa.me/6287831025157?text=Halo%2C%20saya%20ingin%20tanya%20tentang%20Klinik%20Invoice';
    wa.target = '_blank';
    wa.rel = 'noopener';
    ...
    wa.innerHTML = `
        <span class="wa-float-label">Butuh bantuan? 💬</span>
